...
return <div className={styles.side}>
    <div className={styles.social}>
        <ul>
            <a href={`http://facebook.com/${social.facebook_id}`} target="_blank"><li><FontAwesomeIcon icon={faFacebook} /></li></a>
            <a href={`http://twitter.com/${social.twitter_id}`} target="_blank"><li><FontAwesomeIcon icon={faTwitter} /></li></a>
            <a href={`http://instagram.com/${social.instagram_id}`} target="_blank"><li><FontAwesomeIcon icon={faInstagram} /></li></a>
        </ul>
    </div>
